<template>
  <div class="header-tool__wrapper header-tool__profile">
    <div>
      <button
        class="header-tool header-tool__mobile"
        @click="openSignIn"
      >
      ...
      <button class="header-tool header-tool__desktop" @click="openSignIn">
        <div class="header-tool__icon">
          <svg
            fill="none"
            height="32"
...
const SignIn = () => import('@/components/authorization/authorization-modal');
